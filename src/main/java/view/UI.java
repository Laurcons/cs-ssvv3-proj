...
public class UI {
    ...
    public void run() {
        ...
        this.service.addStudent(new Student(
                "student-adaugat",
                "student-adaugat",
                10,
                "student@adaugat"
        ));
        this.service.addTema(
                new Tema(
                        "tema-adaugata",
                        "tema-adaugata",
                        4,
    ...
    private void meniuStudent() {
        while (true) {
            ...
            System.out.println("6. Note laborator pt fiecare student");
            System.out.println("7. Studenti care pot intra in examen");
            System.out.println("8. Studenti care au predat la timp temele");
            Scanner scanner = new Scanner(System.in);
            System.out.print("Introduceti comanda: ");
            int comanda = scanner.nextInt();
            if (comanda == 0) {
                ...
                this.service.get_lab_grades();
            } else if (comanda == 7) {
                this.service.get_students_who_enter_exam();
            } else if (comanda == 8) {
                this.service.get_students_who_delivered();
            } else {
                System.out.println("Comanda invalida!");
            }
        }
